...
[![Java 25+](https://img.shields.io/badge/Java-25%2B-brightgreen?style=flat-square)](https://adoptium.net/)
...
- **Permission-driven ranks** - Define any number of mining ranks with drop multipliers,
  ...
  qualify for based on `settings.rank-order`.
- **Block overrides** - Fine-tune individual materials per rank without touching global
  defaults (e.g. triple drops on ancient debris only).
- **World and region profiles** - Map different rank ladders to worlds or WorldGuard regions.
...
- **[WorldGuard](https://modrinth.com/plugin/worldguard)** - Restrict perks to specific regions.
...
| [EzSkills](https://modrinth.com/plugin/ezskills) | 2.0+ *(optional)* |
...
| [WorldGuard](https://modrinth.com/plugin/worldguard) | any *(optional)* |
